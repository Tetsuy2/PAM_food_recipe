...
class RecipeDetailsPage extends StatelessWidget {
    ...
    if (authorAvatar.startsWith('http')) {
      return Image.network(
        ...
        errorBuilder: (_, __, ___) =>
            Image.asset('assets/user2.png', width: 40, height: 40),
      );
    }
    return Image.asset(
      authorAvatar,
  ...
  Widget _buildIngredientIcon(String img) {
    if (img.startsWith('http')) {
      return Image.network(
        ...
        fit: BoxFit.contain,
        errorBuilder: (_, __, ___) =>
            Image.asset('assets/tomatos.png', width: 32, height: 32),
      );
    }
    return Image.asset(
      img,
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        // ingredients
        ...ingredients.map(
          (it) => _ing(hp, it.image, it.name, it.amount, _buildIngredientIcon),
        ),
      ],
    );
  }
  ...
  static Widget _ing(
    ...
    String name,
    String amt,
    Widget Function(String) iconBuilder,
  ) {
    return Padding(
